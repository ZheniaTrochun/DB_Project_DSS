...
**Замовник**(в контексті даного документу) - фізична чи юридична особа, яка яка робить замовлення на створення і подальше використання нашої системи підтримки прийняття рішень.
...
#### 3.5.1.	Сценарій обробки заявки замовлення клієнта.
  ...
  6. Підчас виконання заявки, клієнт через особистий кабінет може слідкувати за поточним станом замовлення, бачити які кроки вже виконані та що ще потрібно зробити, скільки потрібно часу і т.д.
