...
#### 3.5.3.	Сценарій формалізації прийняття рішення
 1. Замовник отримує результати роботи розробника(у вигляді дашборду),
	з необхідною інформацією у вигляді графіків, діаграм, текстової інформації і т.д.
 2. Замовник аналізує різносторонню інформацію подану на дашборді в окремих сферах(аналіз ринку збуту, потенціальних партнерів, тощо)
 3. На основі зібранної витримки з дашборду, замовник приймає рішення.

#### 3.5.4.	Конфіденційність інформації
