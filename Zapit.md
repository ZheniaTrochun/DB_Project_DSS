...
#### 3.5.4. Процес прийняття рішення
...
#### 3.5.5.	Конфіденційність інформації
...
* Розробка дашборду:
  * насамперед, основною функцією розробника є розробка дешборду, тому особливо важливо розробити набір зручного ПО, яким він буде користуватися
