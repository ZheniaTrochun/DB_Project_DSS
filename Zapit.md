...
### 3.3. Представлення системи з позиції кожного з учасників
#### 3.3.1 Замовник 
...
#### 3.6.1.	Сценарій обробки заявки замовлення клієнта.
 ...
 4. Оператор отримує заявку та зв'язується з замовником і корегує її.
 ...
 7. Розробник зв’язується з клієнтом для створення ТЗ.
...
#### 3.6.3.	Сценарій роботи розробника
...
#### 3.6.5. Процес прийняття рішення
...
#### 3.6.6.	Конфіденційність інформації
